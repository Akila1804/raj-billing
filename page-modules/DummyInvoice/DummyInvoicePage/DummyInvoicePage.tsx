...
import {
  ADD_DUMMY_INVOICE,
  DASHBOARD,
  PREVIEW_DUMMY_INVOICE,
  UPDATE_DUMMY_INVOICE,
} from "@/constants/path";
...
export default function DummyInvoicePage({ invoice }: InvoiceInterface) {
  ...
  const thisMonthCount = invoice.filter((d) => {
    const now = new Date();
            ...
            <table className="w-full text-sm">
              <thead className="bg-gray-100 text-gray-600">
                <tr>
                  ...
                  <th className="p-3 text-left">Dummy Invoice No</th>
                    ...
                    <td className="p-3">
                      <div className="flex justify-center gap-2">
                        <button
                          ...
                          onClick={() =>
                            router.push(
                              `${PREVIEW_DUMMY_INVOICE}?id=${item.duminvoiceNo}`,
                            )
                          }
                          title="Preview"
                        >
                        ...
                        <button
                          ...
                          onClick={() =>
                            router.push(
                              `${UPDATE_DUMMY_INVOICE}?id=${item.duminvoiceNo}`,
                            )
                          }
                          title="Edit"
                        >
