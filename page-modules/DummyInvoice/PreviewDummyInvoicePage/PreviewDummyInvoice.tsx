...
const PreviewDummyInvoice = () => {
  ...
  const downloadJPG = async () => {
    ...
    link.href = imgData;
    link.download = `${form.duminvoiceNo}.jpg`;
    link.click();
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex justify-center bg-gray-200 pb-10">
        <div
          ref={invoiceRef}
          className="flex flex-col justify-between print-container"
          style={{
            width: "210mm",
            minHeight: "297mm",
            overflow: "hidden",
        ...
        >
          ...
          {/* <div className="flex flex-col justify-between print-inner"> */}
          <div className=" text-black">
            ...
            <div className=" flex col-span-2 gap-2 border-black rounded-lg ">
              <div className="p-4 py-2 rounded-lg w-full text-sm">
                ...
                <p className={`${isMoreProducts ? "text-[10px]" : "text-sm"}`}>
...
export default PreviewDummyInvoice;
